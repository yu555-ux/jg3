...
import CommandSetModal from './modal/CommandSetModal';
      ...
      case 'api_mode':
        return (
          <ApiModeModal
            ...
            luckApiConfig={luckApiConfig || { apiurl: '', key: '', model: '', retries: 0 }}
            onUpdateLuckApiConfig={onUpdateLuckApiConfig || (() => {})}
          />
        );
      case 'memory_storage':
        return (
